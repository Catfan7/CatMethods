...
{
    // "bool newline" determines whether a newline is created after the printed statement
    public static void prts(String x, bool newline)
    {
        Console.Write(x);
        if (newline)
        {
    ...
    public static void prti(int x, bool newline) { 
        Console.Write(x);
        if (newline)
        {
            Console.Write("\n");
    ...
    public static void prtf(float x, bool newline) { 
        Console.Write(x);
        if (newline)
        {
            Console.Write("\n");
    ...
    public static void prtd(double x, bool newline) { 
        Console.Write(x);
        if (newline)
        {
            Console.Write("\n");
    ...
    public static void prtb(bool x, bool newline) { 
        Console.Write(x);
        if (newline)
        {
            Console.Write("\n");
    ...
    public static void prtc(char x, bool newline) {
        Console.Write(x);
        if (newline)
        {
            Console.Write("\n");
